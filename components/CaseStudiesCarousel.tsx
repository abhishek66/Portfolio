        ...
        >
          ...
          >
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              <button type="button" onClick={prev} aria-label="Previous" className="sm:hidden flex h-8 w-8 items-center justify-center rounded-full" style={{ background: "rgba(99,102,241,0.12)", border: "1px solid rgba(99,102,241,0.35)", color: "#6366F1" }}>
                ...
                {featured.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      height: "7px",
                      borderRadius: "9999px",
                      background: selected === i ? "#6366F1" : "rgba(99,102,241,0.30)",
                      transition: "width 250ms ease, background 250ms ease",
                    }}
                  />
                ))}
              </div>
              <button type="button" onClick={next} aria-label="Next" className="sm:hidden flex h-8 w-8 items-center justify-center rounded-full" style={{ background: "rgba(99,102,241,0.12)", border: "1px solid rgba(99,102,241,0.35)", color: "#6366F1" }}>
