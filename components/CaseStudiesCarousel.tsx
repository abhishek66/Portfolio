      ...
      {study && (
        ...
        >
          ...
          <button
            ...
            style={{ background: "rgba(245,197,24,0.12)", border: "1px solid rgba(245,197,24,0.35)", color: "#F5C518" }}
          >
          ...
          >
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              <button type="button" onClick={prev} aria-label="Previous" className="sm:hidden flex h-8 w-8 items-center justify-center rounded-full" style={{ background: "rgba(245,197,24,0.12)", border: "1px solid rgba(245,197,24,0.35)", color: "#F5C518" }}>
                ...
                {featured.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      height: "7px",
                      borderRadius: "9999px",
                      background: selected === i ? "#F5C518" : "rgba(245,197,24,0.30)",
                      transition: "width 250ms ease, background 250ms ease",
                    }}
                  />
                ))}
              </div>
              <button type="button" onClick={next} aria-label="Next" className="sm:hidden flex h-8 w-8 items-center justify-center rounded-full" style={{ background: "rgba(245,197,24,0.12)", border: "1px solid rgba(245,197,24,0.35)", color: "#F5C518" }}>
