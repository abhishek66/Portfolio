  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow: scrolled ? "0 1px 24px rgba(139,105,20,0.08)" : "none",
        transition:
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.background = "rgba(139,105,20,0.18)";
              (e.currentTarget as HTMLElement).style.boxShadow  = "0 0 0 1px var(--border-strong), 0 0 12px rgba(139,105,20,0.2)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLElement).style.background = "rgba(139,105,20,0.10)";
