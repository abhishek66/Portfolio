          ...
          <div className="flex flex-col-reverse items-center gap-14 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2">
                {["MSc Business Analysis", "University of Strathclyde", "4+ Years Experience"].map((chip) => (
                  <span
                    key={chip}
                    className="skill-tag inline-flex items-center rounded-full border border-[rgba(245,197,24,0.40)] bg-[rgba(245,197,24,0.12)] px-3 py-1 font-data text-xs"
                  >
                    {chip}
                  </span>
                ))}
            ...
            <div className="flex-shrink-0 -mt-4 lg:-mt-8">
              <div
                ...
                style={{
                  boxShadow: "0 0 0 1px rgba(245,197,24,0.20), var(--shadow-glow)",
                }}
              >
                <Image
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(160deg, rgba(245,197,24,0.10) 0%, transparent 60%)",
                  }}
                />
              </div>
            </div>
